...
ActiveRecord::Schema[8.1].define(version: 2026_08_17_000000) do
  ...
  create_table "banner_details", force: :cascade do |t|
    t.string "analytics_title"
    t.datetime "created_at", null: false
    t.integer "detailable_id"
    t.string "detailable_type"
    t.datetime "updated_at", null: false
    t.index ["detailable_type", "detailable_id"], name: "index_banner_details_on_detailable"
  end

  create_table "banner_notes", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "notable_id"
    t.string "notable_type"
    t.string "note"
    t.datetime "updated_at", null: false
    t.index ["notable_type", "notable_id"], name: "index_banner_notes_on_notable"
  end
